...
export default {
    input: 'src/index.ts',
    output: [
        { name: "MagicBarrageJs", file: pkg.main, format: 'cjs', sourcemap },
        { name: "MagicBarrageJs", file: pkg.module, format: 'es', sourcemap },
        { name: "MagicBarrageJs", file: pkg.unpkg, format: 'umd', sourcemap }
    ],
    plugins: [
